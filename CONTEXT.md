# Contexte de developpement - Valdoria

Ce fichier sert de reference rapide pour les deux devs du projet. Il doit rester simple, concret et a jour.

## Objectif du projet

Valdoria est une page web statique qui lance une ROM GBA fournie par le joueur, lit la position du personnage en memoire, synchronise cette position en P2P, puis affiche l'ami par-dessus l'ecran de jeu.
